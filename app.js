...
const flag_details = {
  ...
  "temp-tipo": {
    ...
    uc_string: "En varios contratos el tiempo para preparar la oferta es insuficiente, esto genera in eficiencias en el proceso de contratación y podría ir contra lo estipulado en la ley.",
    hidden_uc: false,
  },
  "temp-fs": {
    id: "temp-fs",
