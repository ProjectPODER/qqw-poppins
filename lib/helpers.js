...
const helpers = {
  ...
  get_type_plural: function(type, short=false) {
    switch(type) {
      case "institutions": return short ? "Instituciones" : "Instituciones públicas o empresas productivas del estado";
      case "municipality": return "Municipios";
      case "state": return "Estados";
      case "company": return short ? "Empresas" :"Empresas o asociaciones civiles";
      case "companies": return short ? "Empresas" :"Empresas o asociaciones civiles";
      case "contract": return "Contratos";
      case "contracts": return "Contratos";
      case "persons": return "Personas";
      case "person": return "Personas";
      case "funder": return "Bancos";
      case "countries": return "Países";
      case "all": return "Todo";
      default: console.log("get_type_plural",type); return "Entidades";
    }
  },
  get_type_singular: function(type) {
    switch(type) {
      case "institutions": return "Institución pública o empresa productiva del estado";
      case "municipality": return "Municipio";
      case "state": return "Estado";
      case "company": return "Empresa o asociación civil";
      case "contract": return "Contrato";
      case "persons": return "Persona";
      case "person": return "Persona";
      case "funder": return "Banco";
      default: console.log("get_type_singular",type); return "Entidad";
    }
  },
