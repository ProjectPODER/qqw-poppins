...
const helpers = {
  ...
  get_type_plural: function(type, short=false) {
    switch(type) {
      case "institutions": return short ? "Instituciones" : "Instituciones públicas o empresas productivas del estado"; break;
      case "municipality": return "Municipios"; break;
      case "state": return "Estados"; break;
      case "company": return short ? "Empresas" :"Empresas o asociaciones civiles"; break;
      case "companies": return short ? "Empresas" :"Empresas o asociaciones civiles"; break;
      case "contract": return "Contratos"; break;
      case "contracts": return "Contratos"; break;
