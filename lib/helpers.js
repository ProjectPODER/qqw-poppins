...
const helpers = {
  ...
  format_amount: function(value, currency) {
    ...
    else if (value >= 1000000000000) {value /= 1000000000000; suffix="billones"}
    else if (value >= 1000000000) {value /= 1000000000; suffix="mil millones"}
    else if (value >= 1000000) {value /= 1000000; suffix="millones"}
    else if (value >= 100000) {value /= 100000; suffix="cientos de miles"}
    else if (value >= 2000) {value /= 1000; suffix="miles"}
