...
const filter_elements = [
    ...
    apiFilterName: "name",
		...
		type:"string",
    collections: ["all"],
    guidanceText: "Filtrar resultados por nombre, título o producto.",
	...
	},
  {
    ...
    show_if: "estado",
		collections: ["all-only","institutions","areas","companies"],
    autocomplete_enabled: true,
    autocomplete_parameters: "classification=city",
		default: { label: "Todas" },
	},
  // {
  ...
  */
  ...
  //Sort products
    ...
    type:"select",
		...
		align: "right",
		default: {
			value: "contract_amount" //"purchase_amount.products"
		},
		options: {
      // "": "Destacadas",
			// "purchase_amount.products": "Importe comprado",
			// "purchase_count.products": "Cantidad de compras",
			// "purchase_quantity.products": "Cantidad de unidades compradas",
			"contract_amount": "Importe comprado",
			"contract_count": "Cantidad de compras",
			"contract_quantity": "Cantidad de unidades compradas",
			"name.keyword": "Nombre"
		}
	},
	{
