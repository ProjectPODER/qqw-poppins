...
const filter_elements = [
	{ htmlFieldName: "collection", apiFieldNames:["_collection"], fieldLabel:"Tipo", type:"select", collections: ["all"] },
	{ htmlFieldName: "filtername", apiFieldNames:["compiledRelease.name"], fieldLabel:"Nombre", type:"string", collections: ["persons","institutions","companies","all"], placeholder: "Ingrese parte del nombre" },
	{ htmlFieldName: "identifier", apiFieldNames:["compiledRelease.identifiers.id"], fieldLabel:"Identificador (RFC, RUPC, etc)", type:"string", collections: ["companies"], guidanceText: "Solo tenemos esta información de aquellas empresas que han recibido contratos en 2019" },
  { htmlFieldName: "importe-proveedor", apiFieldNames:["compiledRelease.contract_amount.supplier"], fieldLabel:"Importe proveedor", type:"minmax", collections: ["persons","institutions","companies"] },
  { htmlFieldName: "cantidad-proveedor", apiFieldNames:["compiledRelease.contract_count.supplier"], fieldLabel:"Cantidad proveedor", type:"minmax", collections: ["persons","institutions","companies"] },
  { htmlFieldName: "importe-comprador", apiFieldNames:["compiledRelease.contract_amount.buyer"], fieldLabel:"Importe comprador", type:"minmax", collections: ["institutions"] },
  { htmlFieldName: "cantidad-comprador", apiFieldNames:["compiledRelease.contract_count.buyer"], fieldLabel:"Cantidad comprador", type:"minmax", collections: ["institutions"] },
  ...
  { htmlFieldName: "size", apiFieldNames:["limit"], fieldLabel:"Resultados por página", type:"integer", hidden: true, collections: ["all"] },
	{ htmlFieldName: "sort", apiFieldNames:["sort"], fieldLabel:"Orden", type:"string", collections: ["all"], align: "right" },
	{ htmlFieldName: "sortDirection", fieldIcon:"fa-sort-amount-down", labelType: "icon", apiFieldNames:["_sortDirection"], fieldLabel:"Dirección del orden", type:"onlybutton", collections: ["all"], align: "right" },
...
const role_names = {
  "parent": {
    "Punto de Contacto": "Responsable de la unidad",
    "Shareholder": "Accionista de",
    "Boardmember": "Consejera/o de",
    "Unidad Compradora": "Unidades compradoras",
    "Pertenece a Municipio": "Dependencias del municipio",
    "Municipio": "Municipios",
    "Parent Organization":"Subsidiarias",
    "Pertenece a Estado":"Dependencias del Estado",
    "director":"Director/a de",
    "individual-person-with-significant-control":"Persona con control significativo de",
    "llp-designated-member":"Integrante designada/o de una LLP",
    "llp-member":"Integrante de una LLP",
    "secretary":"Secretaria/o de",
    "Estado":"Estado 1",  //esto me parece que no sirve
    "Emisor de Acciones":"Empresas emisoras",
    "Consejero de Emisor de Acciones": "Consejeras/os de empresas"
  },
  "child": {
    "Punto de Contacto": "Responsable de unidad compradora",
    "Shareholder": "Accionistas",
    "Boardmember": "Consejeras/os",
    "Unidad Compradora": "Pertenece a la dependencia",
    "Pertenece a Municipio": "Pertenece al municipio de",
    "Municipio": "Estado",
    "Parent Organization":"Matriz",
    "Pertenece a Estado":"Estado   al que pertenece",
    "director":"Directores/as",
    "individual-person-with-significant-control":"Personas con control significativo",
    "llp-designated-member":"Integrantes designadas/os de la LLP",
    "llp-member":"Integrantes de la LLP",
    "secretary":"Secretarias/os",
    "Estado":"Estado 2", //esto me parece que no sirve
    "Emisor de Acciones":"Cotiza en bolsa",
    "Consejero de Emisor de Acciones": "Bolsas en las que cotizan"
  }
}

const role_icons = {
  "parent": {
    "Punto de Contacto": "fa-user-tag",
    "Shareholder": "fa-hand-holding-usd",
    "Boardmember": "fa-user-tie",
    "Unidad Compradora": "fa-shopping-cart",
    "Pertenece a Municipio": "fa-landmark",
    "Municipio": "fa-city",
    "Parent Organization":"fa-project-diagram",
    "Pertenece a Estado":"fa-landmark",
    "Emisor de Acciones":"fa-chart-line",
    "Consejero de Emisor de Acciones": "fa-user-tie"
  },
  "child": {
    "Punto de Contacto": "fa-shopping-cart",
    "Shareholder": "fa-hand-holding-usd",
    "Boardmember": "fa-user-tie",
    "Unidad Compradora": "fa-landmark",
    "Pertenece a Municipio": "fa-city",
    "Municipio": "fa-map-marked",
    "Parent Organization":"fa-kaaba",
    "Pertenece a Estado":"fa-map-marked",
    "Emisor de Acciones":"fa-chart-line",
    "Consejero de Emisor de Acciones": "fa-chart-line"
  }
}
