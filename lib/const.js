...
const filter_elements = [
    ...
    options: [
      ...
      {id: "contracts", label: "Contratos", description: "Explora los importes, años, dependencias, empresas proveedoras y otras características de millones de contratos."},
      {id: "persons", label: "Personas", description: "Conoce cómo se relacionan los personajes de las élites políticas y económicas."},
      ...
      {id: "institutions", label: "Instituciones públicas", description: "Entidades y dependencias del gobierno, incluyendo empresas productivas del estado"},
    ...
    apiFilterName: "identifier",
		...
		guidanceText: "Solo tenemos esta información de aquellas empresas que han recibido contratos en México a partir de 2019.",
		default: { label: "Todos" },
  },
  /*
      "values" : {
