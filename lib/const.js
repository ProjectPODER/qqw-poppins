...
const filter_elements = [
	...
	},
  {
		...
		collections: ["persons","institutions","companies"],
		options: [
			{ min: "", max: "1", label: "Sin contratos" },
			{ min: "2", max: "10", label: "2 a 10 contratos" },
		],
		default: { label: "Todos" },
	},
  {
	...
	},
  {
		...
		fieldLabel:"País",
		type:"select",
		collections: ["persons","companies","institutions"],
		options: {
			"ar":"Argentina",
			"mx": "México",
			"": "Todos",
  ...
  },
  {
    ...
    options: {
      "cnet": "CompraNet",
      "mujeres2020": "Mujeres en la bolsa"
    },
    default: { label: "Todas" },
  ...
  },
  {
	...
	{
		htmlFieldName: "sort-cpi",
		apiFieldNames:["sort"],
		fieldLabel:"Orden",
		type:"select",
		collections: ["companies","persons","institutions"],
		align: "right",
		default: {
			value: "compiledRelease.contract_amount.supplier"
		},
		options: {
			"compiledRelease.contract_amount.supplier": "Importe proveedor"
		}
	},
	{
		...
		align: "right",
		default: {
			value: "compiledRelease.total_amount"
		},
		options: {
			"compiledRelease.total_amount": "Importe"
		}
	},
	{
		...
		align: "right",
		options: [
			{ value: "-", label: "Mayor a menor", icon:"fa-sort-amount-down" },
			{ value: "+", label: "Menor a mayor", icon:"fa-sort-amount-up" },
	 	],
		default: { value: "-" },
	},
	{
