...
const filter_elements = [
    ...
    default: { label: "Todos" },
    options: [
      {id: "", label: "Todas", description: "Búsqueda de personas, empresas, instituciones, áreas y contratos. No permite filtrar."},
      {id: "contracts", label: "Contratos", description: "Explora los importes, años, dependencias, empresas proveedoras y otras características de más de tres millones de contratos de México."},
      {id: "persons", label: "Personas", description: "Conoce cómo se relacionan los personajes de las élites políticas y económicas en México"},
      ...
      {id: "institutions", label: "Instituciones públicas", description: "ntidades y dependencias del gobierno, incluyendo empresas productivas del estado"},
      {id: "areas", label: "Países y estados", description: "Áreas geográficas en que existan personas, empresas, instituciones públicas o contratos."},  
    ]
	},
	{
    htmlFieldName: "name",
    apiFilterName: "name",
		...
		type:"string",
    collections: ["all"],
    guidanceText: "Para filtrar contratos por título utilice el filtro de título.",
  ...
  */
  ...
  },
  {
    ...
    options: {
      "": "Todas",
      "compranet": "CompraNet",
      "compranet3": "CompraNet 3 (viejo)",
      "pot": "Portal de Obligaciones de Transparencia",
      "mujeres2019": "Mujeres en la bolsa (2019)",
      "mujeres2020": "Bolsas de valores (2020)",
      "latam_offshore": "América Latina Off-Shore",
      "tdc": "Torre de Control"
    },
    default: { value: "" },
  },
  {
  ...
  //TODO: Sort for all?
    ...
    apiFilterName: "sort",
		fieldLabel:"Orden",
    type:"select",
		collections: ["companies","persons","institutions","areas"],
		align: "right",
		default: {
...
const qqw_routes = [
  ...
  { es: "paises/:id/mujeresenlabolsa", en: "countries/:id/women-in-the-stock-exchange", view: "entityPage", params: ["countries","country-mujeres","id"] },
  { es: "paises/:id", en: "countries/:id", view: "entityPage", params: ["countries","country","id"] },
...
const classification_names = {
  ...
  "persons": {
    ...
    [array_proveedor_funcionario] : {
      "undefined": {
        "undefined": "Proveedor y funcionario",
      },        
    },
    ["funcionario"]: {
      "undefined": {
        "undefined": "Funcionario",
      },        
    },
...
const role_names = {
  ...
  "individual-person-with-significant-control": { //Falta icono
    "child": {
  ...
  "llp-designated-member": { //Falta icono
    "child": {
