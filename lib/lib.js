...
async function getAPI(req,collection,filters,debug) {
  ...
  if (collection=="contracts") {
    ...
    if (!filters['compiledRelease.contracts.title']) {
...
function sendMail(req, callback) {
  ...
  // SEND INFORMATION FORM
    ...
    mailOptions.html=  "From: " + req.body.email + "<br>" +
                       "Information: " + req.body.message + "<br>" + "Source: " + req.body.source + "<br>" + "Url: " + req.body.url
  }
  ...
  // SEND INFORMATION UC
    ...
    mailOptions.html=  "From: " + req.body.email + "<br>" +
                       "Institution: " + req.body.institution + "<br>" + "Name: " + req.body.name + "<br>" + "Url: " + req.body.url
  }
...
function fixContractResultList(result) {
  // console.log(result);
  if (result && result.data[0] && result.data[0].records && result.data[0].records.length > 0) {
